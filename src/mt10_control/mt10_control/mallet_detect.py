...
class YOLOSearchTrackNode(Node):
    def __init__(self):
        ...
        self.continue_sub = self.create_subscription(
            String, "/continue_search_mallet", self.continue_callback, 10
        )
        ...
        self.cap = cv2.VideoCapture("/dev/v4l/by-id/usb-046d_Logitech_Webcam_C930e-video-index0", cv2.CAP_V4L2)
        ...
        self.log_info('YOLO Mallet Search and Track Node initialized')
