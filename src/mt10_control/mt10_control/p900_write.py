...
class SerialCommunicator(Node):
    def __init__(self):
        ...
        self.create_subscription(String, "/aruco_status", self.status_callback, 10)
        self.create_subscription(String, "/mallet_status", self.status_callback, 10)
        self.create_subscription(String, "/bottle_status", self.status_callback, 10)
