...
class Autonomous(Node):
    def __init__(self, max_lin_vel=100.0, max_ang_vel=80.0, yaw_threshold=15, distance_threshold=1.5):
        ...
        self.ar_resume = self.create_publisher(String, "/continue_search_ar", 10)
        self.mallet_resume = self.create_publisher(String, "/continue_search_mallet", 10)
        self.bottle_resume = self.create_publisher(String, "/continue_search_bottle", 10)
        ...
        self.autonomous_timer = self.create_timer(0.08, self.autonomous_callback)
